...
footer_page="object/footer/index.html"
...
class before:
    def html_maker(i):
        ...
        line30="\t\t<object data=\"{}/side_add_ons/object/links/index.html\" type=\"text/html\" class=\"main_men_page\">".format(website_name,bootstrap_location
        line31="\t\t\talt : <p>Les choix du menu: <a href=\"{}/{}/object/links/index.html\">Menu Principal</a></p>".format(website_name,bootstrap_location
        line32="\t\t</object>"
        line33="\t\t<br>"
        line34="\t\t<br>"
        line35="\t\t<br>"
        line36="\t\t<br>"
        line37="\t\t<footer>"
        line38="\t\t\t<object data=\"{}/{}/{}\" type=\"text/html\" class=\"fooject\">".format(website_name,bootstrap_location,footer_page)
        line39="\t\t\t\talt : <p>{}<a href=\"{}/{}/{}\">{}</a></p>".format(error_message,website_name,bootstrap_location,footer_page,error_message2)
        line40="\t\t\t</object>"
        line41="\t\t</footer>"
        line42="\t</body>"
        line43="</html>"
        ...
        line28,line29,line30,line31,line32,line33,line34,line35,line36]
        return page
    def list_maker(a):
        c=[]
        word=""

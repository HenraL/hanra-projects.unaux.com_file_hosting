...
class before:
    def html_maker(i):
        ...
        lineBLink="\t\t<span id=\"LiNks\">...</span>"
        lineLink="\t\t<script type=\"text/JavaScript\" src=\"{}/{}/{}\"></script>".format(website_name,bootstrap_location,links_page)
        line30="\t\t<footer>"
        lineBFooter="\t\t<span id=\"FoOtEr\">...</span>"
        lineFooter="<script type=\"text/JavaScript\" src=\"{}/{}/{}\"></script>".format(website_name,bootstrap_location,footer_page)
        ...
        line33="\t\t\t</object>"
        line34="\t\t</footer>"
        lineCall="<script type=\"text/JavaScript\">links(\"LiNks\");footer(\"FoOtEr\");</script>"
        line35="\t</body>"
        line36="</html>"
        ...
        line28,line29,lineBLink,lineLink,line30,
        # line31,line32,line33,
        lineBFooter,lineFooter,line34,lineCall,line35,line36]
        return page
    def list_maker(a):
        c=[]
        word=""

  ...
  (function () {
    aJSsTemplate.JsMenu = function (b, a) {
      ...
      if (
        ...
        i.onclick = function () {
            var val=confirm("i.onclick (desactivated) line: 578 to 594\nHowever you can still open the link if you wish.\n Do want to open the link?");
            if (val == true){
                window.open("http://www.anvsoft.com/",target="_blank");
                alert("Opening Link http://www.anvsoft.com/")
            }else{
                alert("The link has not been opened.");
            };
        //   switch (h) {
        //     case "anvsoftPFMTheme":
    ...
    aJSs.JsMenu = function (b, a) {
      ...
      if (
        ...
        h.onEvent = function (a) {
            alert("h.event (desactivated) line: 4908 to 4926");
        //   if ("mousedown" == a.type || "touchend" == a.type)
        //     switch (f) {
        //       case "anvsoftPFMTheme":
        //         window.open("http://www.photo-flash-maker.com/", "_self");
